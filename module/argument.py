...
def get_parser():
    ...
    parser.add_argument('--burn', type = int, default = 20, help = 'burn-in period')
    parser.add_argument('--dataset', type = str, default = 'bbbp', help = 'bace, bbbp, clintox, hiv, muv, sider, tox21, toxcast')
